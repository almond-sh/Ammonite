...
/**
 * The [[GlobalMaker]] for the scalac of 2.12.0 to 2.12.8.
 *
 ...
 * 2.12.0 to 2.12.8 - 2.12.9 added fields to `Contexts`, `Implicits` and `Macros`.
 */
class GlobalMaker2_12_0__2_12_8 extends GlobalMaker {
